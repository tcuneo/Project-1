...
$("")
  ...
  var timer;
    ...
    start: function() {
      ...
      $("#timer").prepend("<h2>Time Remaining: <span id='counter-number'>0</span> s</h2>");
    ...
    countdown: function() {
      ...
      if (game.counter > 0) {
        $("#highscore-div").html("Score: " + pacman.score);
      }
  ...
  $("#start").on("click", function() {
    ...
    if (game.counter === 0) {
      // document.getElementById("myDIV").removeEventListener("keydown", e);
      $("#highscore-div").html("Score: " + pacman.score);
    }
